...
import { getMLSTeamBySlug } from "@/data/mlsTeams";
import { getMLSLogo } from "@/data/mlsLogos";
import { useTeamGames } from "@/hooks/useTeamGames";

const TeamMLSPage = () => {
  const { slug } = useParams<{ slug: string }>();
  const team = slug ? getMLSTeamBySlug(slug) : undefined;
  const teamLogo = slug ? getMLSLogo(slug) : undefined;
