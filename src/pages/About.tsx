      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="bg-card border border-border rounded-2xl p-8 md:p-12 shadow-lg space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Our membership model is what makes this possible. For just $59.99 a year (regular $99.99 — 40% off during launch), members pay zero service fees nor LCC on every single purchase. No catches, no fine print.
            </p>
          </div>
        </div>
      </section>
