...
import { getNFLTeamBySlug } from "@/data/nflTeams";
import { getNFLLogo } from "@/data/nflLogos";
import { useTeamGames } from "@/hooks/useTeamGames";

const TeamNFLPage = () => {
  const { slug } = useParams<{ slug: string }>();
  const team = slug ? getNFLTeamBySlug(slug) : undefined;
  const teamLogo = slug ? getNFLLogo(slug) : undefined;
