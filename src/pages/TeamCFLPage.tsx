...
import { getCFLTeamBySlug } from "@/data/cflTeams";
import { getCFLLogo } from "@/data/cflLogos";
...
const TeamCFLPage = () => {
  ...
  const team = slug ? getCFLTeamBySlug(slug) : undefined;
  const teamLogo = slug ? getCFLLogo(slug) : undefined;
