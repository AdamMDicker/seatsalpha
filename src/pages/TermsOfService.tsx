      ...
      <main className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3"><strong className="text-foreground">Buyer Chargeback Abuse & Recovery:</strong> If a buyer initiates a payment dispute or chargeback after receiving valid tickets as described in the listing, seats.ca reserves the right to recover the full disputed amount and any associated fees — including bank processing fees, administrative costs, and payment processor penalties — from the buyer. In addition, seats.ca may immediately suspend or permanently terminate the buyer's account and all associated accounts. This right of recovery applies regardless of the outcome of the chargeback with the buyer's financial institution.</p>
