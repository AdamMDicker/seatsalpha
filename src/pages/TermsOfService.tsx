    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">11. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">12. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">16. Termination</h2>
            <p>We reserve the right to suspend, restrict, or terminate your access to the Platform at any time, with or without cause or prior notice, including but not limited to cases of suspected fraud, violation of these Terms, or conduct that we determine is harmful to other users or to the integrity of the marketplace. Upon termination, your right to use the Platform will immediately cease. Any provisions of these Terms that by their nature should survive termination shall remain in effect, including but not limited to sections relating to intellectual property, limitation of liability, indemnification, and governing law.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">17. Governing Law</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">18. Severability</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">19. Entire Agreement</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">20. Contact</h2>
