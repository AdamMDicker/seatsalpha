...
const benefits = [
  ...
  { icon: Shield, title: "Trusted Platform", description: "seats.ca is Canada's trusted no extra fees ticket marketplace. Your tickets are backed by our buyer guarantee." },
