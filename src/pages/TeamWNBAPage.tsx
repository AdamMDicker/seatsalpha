...
import { getWNBATeamBySlug } from "@/data/wnbaTeams";
import { getWNBALogo } from "@/data/wnbaLogos";
import { useTeamGames } from "@/hooks/useTeamGames";

const TeamWNBAPage = () => {
  const { slug } = useParams<{ slug: string }>();
  const team = slug ? getWNBATeamBySlug(slug) : undefined;
  const teamLogo = slug ? getWNBALogo(slug) : undefined;
