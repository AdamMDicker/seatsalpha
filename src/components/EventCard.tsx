...
const EventCard = ({ event }: EventCardProps) => {
  return (
    <Link to={getEventTeamPath(event.title, event.id)} className="group block">
      <div className="rounded-xl overflow-hidden bg-card border border-border hover:border-primary/40 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
