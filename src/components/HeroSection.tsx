...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 pt-28 pb-20 flex flex-col items-center text-center">
        <div className="max-w-2xl flex flex-col items-center">
          <h1 className="font-display text-5xl sm:text-6xl md:text-[4.5rem] font-bold leading-[1.05] mb-8 animate-fade-in">
            Compare Every Seat.
            <br />
            <span className="text-gradient">Skip Every Fee.</span>
          </h1>

          <p className="text-lg md:text-xl text-foreground/70 max-w-md mb-12 animate-fade-in leading-relaxed" style={{ animationDelay: "0.1s" }}>
            See real ticket prices across sections and rows. Members never pay service fees or HST.
          </p>

          {/* Search */}
          <div className="flex flex-col sm:flex-row gap-3 max-w-lg w-full mb-10 animate-fade-in relative" style={{ animationDelay: "0.2s" }} ref={resultsRef}>
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-4 rounded-xl bg-card border border-border focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm text-foreground placeholder:text-muted-foreground"
              />
            ...
            <Button variant="hero" className="px-8 py-4 h-auto text-sm font-semibold rounded-xl">
              Search
            </Button>
          </div>
